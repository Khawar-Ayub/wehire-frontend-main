...
import SignupImage from "../../../images/fight.png";
import "../login/jobposting.css";
...
export default function PostJob() {
  ...
  const onSubmit = async (data) => {
    ...
    //   // await
       axios
        .post(`http://localhost:5000/jobs/register`, data)
        .then((res) => {
          if (res.status === 201) {
    ...
    <div className="sign-up">
      ...
      <div className="sign-up-left-container">
        <div className="sign-up-left-wrapper">
          <h2>Post Job</h2>
          <p>Old Skool MMA Fighting Club</p>
...
{/* 11111 */}
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input id="postjob-submit" type="submit" value="Post Job" />
          </form>
